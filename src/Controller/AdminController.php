...
class AdminController extends AbstractController
{
     ...
     */
    public function index(VoitureRepository $repo, Request $request, PaginatorInterface $paginator)
    {
     ...
     */
    public function  modification(Voiture $voiture = null, Request $request, ManagerRegistry $registry)
    {
        if(!$voiture)
        {
            $voiture = new Voiture();
     ...
     */
    public function  suppression(Voiture $voiture, Request $request, ManagerRegistry $registry)
    {
